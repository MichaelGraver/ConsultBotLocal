...
class Sessions(models.Model):
    ...
    FirstTopic = models.CharField(max_length=100, default="")
    FirstSentiment = models.CharField(max_length=100, default="")
    FirstStatement = models.CharField(max_length=100, default="")
    SecondTopic = models.CharField(max_length=100, default="")
    SecondSentiment = models.CharField(max_length=100, default="")
    SecondStatement = models.CharField(max_length=100, default="")
    def __str__(self):
